...
<?php $__env->startSection('pagetitle'); ?>Profile <?php $__env->stopSection(); ?>
            ...
            <div class="user-sidebar">
                        ...
                        <div class="mt-n5 position-relative">
                            <div class="text-center">
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="mt-4 d-flex justify-content-between p-3">
                                        <a href="" class="btn btn-primary waves-effect waves-light btn-sm"><i
                                                class="bx bx-send me-1 align-middle"></i> Send Message</a>
                                        <a href="javascript::void(0)" data-bs-toggle="modal" data-bs-target=".update-profile" class="btn btn-primary waves-effect waves-light btn-sm"><i
                                            class="bx bx-edit me-1 align-middle ml-1"></i> Edit Profile</a>
                                    </div>
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted">Been the industry's standard dummy text To an English person. Our team
                            collaborators and clients to achieve growth.</p>


                        <h5 class="font-size-15">Experience :</h5>
                        <ul class="list-unstyled mb-0 pt-1">
                            <li class="py-1"><i
                                    class="mdi mdi-circle-medium me-1 text-success align-middle"></i>Donec vitae libero
                                venenatis faucibus</li>
                            <li class="py-1"><i
                                    class="mdi mdi-circle-medium me-1 text-success align-middle"></i>Quisque rutrum aenean
                                imperdiet</li>
                            <li class="py-1"><i
                                    class="mdi mdi-circle-medium me-1 text-success align-middle"></i>Integer ante a
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table align-middle table-nowrap mb-0">
                                <tbody>
                                    <tr>
                                        <td style="width: 50px;"><img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>"
                                    ...
                                    <tr>
                                        <td><img src="<?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?>" class="rounded-circle avatar-sm"
                                                alt=""></td>
                                        <td>
                                            <h5 class="font-size-14 m-0"><a href="javascript: void(0);"
                                    ...
                                    <tr>
                                        <td><img src="<?php echo e(URL::asset('assets/images/users/avatar-4.jpg')); ?>" class="rounded-circle avatar-sm"
                                                alt=""></td>
                                        <td>
                                            <h5 class="font-size-14 m-0"><a href="javascript: void(0);"
                ...
                <div class="tab-content p-4">
                                    ...
                                    <li class="checkout-item">
                                        ...
                                        <div class="feed-item-list">
                                            <div>
                                                ...
                                                <div class="mb-3">
                                                    <p>ABC Company</p>
                                                    <p class="text-muted">Proin maximus nibh at lorem bibendum
                                                        venenatis. Cras gravida felis et erat consectetur, ac venenatis quam
                                                        pulvinar.
                    ...
                    <div class="tab-pane" id="messages" role="tabpanel">
                        <div>
                            ...
                            <div class="px-3" data-simplebar style="max-height: 430px;">
                                <div class="d-flex align-items-start border-bottom pb-4">
                                    <div class="flex-shrink-0 me-2">
                                        <img class="rounded-circle avatar-sm" src="<?php echo e(URL::asset('assets/images/users/avatar-3.jpg')); ?>"
                                            alt="avatar-3 images">
                                    </div>
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="font-size-15 mb-1">Marion Walker <small class="text-muted float-end">1
                                                hr ago</small></h5>
                                        <p class="text-muted">Maecenas non vestibulum ante, nec efficitur orci. Duis eu
                                            ornare mi, quis bibendum quam. Etiam imperdiet aliquam purus sit amet rhoncus.
                                            Vestibulum pretium consectetur leo, in mattis ipsum sollicitudin eget.
                                            Pellentesque vel mi tortor.
                                        ...
                                        <div class="d-flex align-items-start mt-4">
                                            <div class="flex-shrink-0 me-2">
                                                <img class="rounded-circle avatar-sm"
                                                    src="<?php echo e(URL::asset('assets/images/users/avatar-4.jpg')); ?>" alt="avatar-4 images">
                                            </div>
                                ...
                                <div class="d-flex align-items-start border-bottom py-4">
                                    <div class="flex-shrink-0 me-2">
                                        <img class="rounded-circle avatar-sm" src="<?php echo e(URL::asset('assets/images/users/avatar-5.jpg')); ?>"
                                            alt="avatar-5 images">
                                    </div>
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="font-size-15 mb-1">Janice Morgan <small class="text-muted float-end">2
                                                hrs ago</small></h5>
                                        <p class="text-muted">Cras ac condimentum velit. Quisque vitae elit auctor quam
                                            egestas congue. Duis eget lorem fringilla, ultrices justo consequat, gravida
                                            lorem. Maecenas orci enim, sodales id condimentum et, nisl arcu aliquam velit,
                                ...
                                <div class="d-flex align-items-start border-bottom py-4">
                                    <div class="flex-shrink-0 me-2">
                                        <img class="rounded-circle avatar-sm" src="<?php echo e(URL::asset('assets/images/users/avatar-7.jpg')); ?>"
                                            alt="avatar-7 images">
                                    </div>
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="font-size-15 mb-1">Patrick Petty <small class="text-muted float-end">3
                                                hrs ago</small></h5>
                                        <p class="text-muted">Aliquam sit amet eros eleifend, tristique ante sit amet,
                                            eleifend arcu. Cras ut diam quam. Fusce quis diam eu augue semper ullamcorper
                                            vitae sed massa. Mauris lacinia, massa a feugiat mattis, leo massa porta eros,
                                            sed congue arcu sem nec orci.
                                        ...
                                        <div class="btn-group" role="group">
                                            <button type="button"
                                                class="btn btn-sm btn-link text-dark text-decoration-none"><i
                                                    class="bx bx-link font-size-15"></i></button>
                                            <button type="button"
                                                class="btn btn-sm btn-link text-dark text-decoration-none"><i
                                                    class="bx bx-smile font-size-15"></i></button>
                                            <button type="button"
                                                class="btn btn-sm btn-link text-dark text-decoration-none"><i
                                                    class="bx bx-at font-size-15"></i></button>
                                        </div>
                        ...
                        <div>
                            ...
                            <div class="blog-post">
                                ...
                                <div class="position-relative mt-3">
                                    <img src="<?php echo e(URL::asset('./assets/images/post-1.jpg')); ?>" alt="" class="img-thumbnail">
                                </div>
                                <div class="pt-3">
                            ...
                            <div class="blog-post mt-4">
                                ...
                                <div class="pt-3">
                                    ...
                                    <p class="text-muted">Aenean ornare mauris velit. Donec imperdiet, massa sit amet
                                        porta maximus, massa justo faucibus nisi,
                                ...
                                <div class="position-relative mt-3">
                                    <img src="<?php echo e(URL::asset('./assets/images/post-2.jpg')); ?>" alt="" class="img-thumbnail">
                                </div>
                                <div class="pt-3">
                                    <div class="d-flex align-items-center justify-content-between border-bottom pb-3">
                                        <div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?php echo e(URL('update-profile/'.Auth::user()->id)); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="avatar" name="avatar" autofocus>
                        ...
                        <div class="text-start mt-2">
                            <img src="<?php if(Auth::user()->avatar != ''): ?><?php echo e(URL::asset('images/'. Auth::user()->avatar)); ?><?php else: ?><?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?><?php endif; ?>" alt="" class="rounded-circle avatar-lg">
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/riskimaulanarahman/Documents/www/borexstartup/resources/views/contacts-profile.blade.php ENDPATH**/ ?>