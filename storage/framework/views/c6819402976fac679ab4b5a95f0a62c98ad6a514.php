<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.Dropdowns'); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>


<?php $__env->startSection('pagetitle'); ?>Dropdowns <?php $__env->stopSection(); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-primary dropdown-toggle-split" data-bs-toggle="dropdown"
                                aria-expanded="false">
                        ...
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-info dropdown-toggle-split" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                <i class="mdi mdi-chevron-down"></i>
                            </button>
                            <div class="dropdown-menu">
                        ...
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-warning dropdown-toggle-split" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                <i class="mdi mdi-chevron-down"></i>
                            </button>
                            <div class="dropdown-menu">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex gap-2 flex-wrap align-items-center">
                        ...
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-sm btn-secondary dropdown-toggle-split"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="mdi mdi-chevron-down"></i>
                            </button>
                            <div class="dropdown-menu">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        ...
                        <div class="btn-group dropend">
                            <button type="button" class="btn btn-info waves-effect waves-light" data-bs-toggle="dropdown"
                                aria-expanded="false">
                        ...
                        <div class="btn-group dropend">
                            ...
                            <button type="button" class="btn btn-info waves-effect waves-light dropdown-toggle-split"
                                data-bs-toggle="dropdown" aria-expanded="false">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/riskimaulanarahman/Documents/www/borexstartup/resources/views/ui-dropdowns.blade.php ENDPATH**/ ?>