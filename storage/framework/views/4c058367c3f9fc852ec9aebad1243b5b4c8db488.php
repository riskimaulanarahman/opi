...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email', 'admin@themesbrand.com')); ?>" id="input-username" placeholder="Enter User Name" name="email">
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/themesbrand/Kaushik/kaushik/laravel/Admin-product/borex-laravel_1.0.0/admin/resources/views/auth/login.blade.php ENDPATH**/ ?>