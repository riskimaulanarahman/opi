<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.Inbox'); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>


<?php $__env->startSection('pagetitle'); ?>Inbox <?php $__env->stopSection(); ?>
                        ...
                        <div class="card p-0 overflow-hidden mt-3 mb-1">
                            <div class="mail-list">
                                <a href="javascript: void(0);" class="d-flex align-items-start border-bottom">
                                    <img class="flex-shrink-0 me-3 rounded-circle" src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>"
                                ...
                                <a href="javascript: void(0);" class="d-flex align-items-start border-bottom">
                                    <img class="flex-shrink-0 me-3 rounded-circle" src="<?php echo e(URL::asset('assets/images/users/avatar-3.jpg')); ?>"
                                        alt="Generic placeholder image" height="36">
                                    <div class="flex-grow-1 chat-user-box">
                                ...
                                <a href="javascript: void(0);" class="d-flex align-items-start border-bottom">
                                    <img class="flex-shrink-0 me-3 rounded-circle" src="<?php echo e(URL::asset('assets/images/users/avatar-4.jpg')); ?>"
                                        alt="Generic placeholder image" height="36">
                                    <div class="flex-grow-1 chat-user-box">
                                ...
                                <a href="javascript: void(0);" class="d-flex align-items-start border-bottom">
                                    <img class="flex-shrink-0 me-3 rounded-circle" src="<?php echo e(URL::asset('assets/images/users/avatar-6.jpg')); ?>"
                                        alt="Generic placeholder image" height="36">
                                    <div class="flex-grow-1 chat-user-box">
                            ...
                            <div class="list">
                                <div class="col-mail col-mail-1">
                                    ...
                                    <div class="d-flex title align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?>" class="avatar-sm rounded-circle"
                                            alt="">
                                ...
                                <div class="col-mail col-mail-2">
                                    <a href="#" class="subject text-dark"> Delectus, ut aut reiciendis – <span
                                            class="teaser text-muted fw-normal">Trip home from Colombo has been arranged,
                                            then Jenna will come get me from Stockholm. :)</span>
                                    </a>
                                    <div class="date"><i
                                            class="mdi mdi-link-variant me-2 font-size-15 align-middle"></i> 5:01 AM</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="message-list mb-0 p-1">
                            <div class="list">
                                <div class="col-mail col-mail-1">
                                    ...
                                    <div class="d-flex title align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" class="avatar-sm rounded-circle"
                                            alt="">
                                        <div class="flex-1 ms-2 ps-1">
                        ...
                        <div class="message-list mb-0 p-1">
                            <div class="list">
                                <div class="col-mail col-mail-1">
                                    ...
                                    <div class="d-flex title align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-4.jpg')); ?>" class="avatar-sm rounded-circle"
                                            alt="">
                                        <div class="flex-1 ms-2 ps-1">
                        ...
                        <div class="message-list mb-0 p-1">
                            <div class="list">
                                <div class="col-mail col-mail-1">
                                    ...
                                    <div class="d-flex title align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-6.jpg')); ?>" class="avatar-sm rounded-circle"
                                            alt="">
                                        <div class="flex-1 ms-2 ps-1">
                        ...
                        <div class="message-list mb-0 p-1">
                            <div class="list">
                                <div class="col-mail col-mail-1">
                                    ...
                                    <div class="d-flex title align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-7.jpg')); ?>" class="avatar-sm rounded-circle"
                                            alt="">
                                        <div class="flex-1 ms-2 ps-1">
                        ...
                        <div class="message-list mb-0 p-1">
                            <div class="list">
                                <div class="col-mail col-mail-1">
                                    ...
                                    <div class="d-flex title align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-3.jpg')); ?>" class="avatar-sm rounded-circle"
                                            alt="">
                                        <div class="flex-1 ms-2 ps-1">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/riskimaulanarahman/Documents/www/borexstartup/resources/views/email-inbox.blade.php ENDPATH**/ ?>