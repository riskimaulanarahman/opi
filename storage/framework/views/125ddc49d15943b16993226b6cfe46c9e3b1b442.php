...
<?php $__env->startSection('pagetitle'); ?>Form Layouts <?php $__env->stopSection(); ?>

    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Form Grid Layout</h4>
                </div>
                <div class="card-body">
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Horizontal Form Layout</h4>
                </div>
                <div class="card-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/riskimaulanarahman/Documents/www/borexstartup/resources/views/form-layouts.blade.php ENDPATH**/ ?>