<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.Projects_Grid'); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>


<?php $__env->startSection('pagetitle'); ?>Projects Grid <?php $__env->stopSection(); ?>
                        ...
                        <div class="avatar-group">
                            <div class="avatar-group-item">
                                <a href="javascript: void(0);" class="d-inline-block">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-4.jpg')); ?>" alt="" class="rounded-circle avatar-sm">
                                </a>
                            </div>
                            <div class="avatar-group-item">
                                <a href="javascript: void(0);" class="d-inline-block">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-5.jpg')); ?>" alt="" class="rounded-circle avatar-sm">
                                </a>
                            </div>
                            <div class="avatar-group-item">
                                <a href="javascript: void(0);" class="d-inline-block">
                            ...
                            <div class="avatar-group-item">
                                <a href="javascript: void(0);" class="d-inline-block">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" alt="" class="rounded-circle avatar-sm">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex">
                        <div class="avatar">
                            <span class="avatar-title rounded bg-light text-danger font-size-16">
                                <img src="<?php echo e(URL::asset('assets/images/companies/img-2.png')); ?>" alt="" height="30">
                            </span>
                        </div>
                        <div class="ms-auto">
                            <div class="dropdown float-end">
                ...
                <div class="px-4 py-2 border-top">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="avatar-group">
                            <div class="avatar-group-item">
                                <a href="javascript: void(0);" class="d-inline-block">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-8.jpg')); ?>" alt="" class="rounded-circle avatar-sm">
                                </a>
                            </div>
                            <div class="avatar-group-item">
                                <a href="javascript: void(0);" class="d-inline-block">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex">
                        <div class="avatar">
                            <span class="avatar-title rounded bg-light text-danger font-size-16">
                                <img src="<?php echo e(URL::asset('assets/images/companies/img-3.png')); ?>" alt="" height="30">
                            </span>
                        </div>
                        <div class="ms-auto">
                            <div class="dropdown float-end">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex">
                        <div class="avatar">
                            <span class="avatar-title rounded bg-light text-danger font-size-16">
                                <img src="<?php echo e(URL::asset('assets/images/companies/img-4.png')); ?>" alt="" height="30">
                            </span>
                        </div>
                        <div class="ms-auto">
                            <div class="dropdown float-end">
                ...
                <div class="px-4 py-2 border-top">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="avatar-group">
                            <div class="avatar-group-item">
                                <a href="javascript: void(0);" class="d-inline-block">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?>" alt="" class="rounded-circle avatar-sm">
                                </a>
                            </div>
                            <div class="avatar-group-item">
                                <a href="javascript: void(0);" class="d-inline-block">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-6.jpg')); ?>" alt="" class="rounded-circle avatar-sm">
                                </a>
                            </div>
                            <div class="avatar-group-item">
                                <a href="javascript: void(0);" class="d-inline-block">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-7.jpg')); ?>" alt="" class="rounded-circle avatar-sm">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex">
                        <div class="avatar">
                            <span class="avatar-title rounded bg-light text-danger font-size-16">
                                <img src="<?php echo e(URL::asset('assets/images/companies/img-5.png')); ?>" alt="" height="30">
                            </span>
                        </div>
                        <div class="ms-auto">
                            <div class="dropdown float-end">
                ...
                <div class="px-4 py-2 border-top">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="avatar-group">
                            ...
                            <div class="avatar-group-item">
                                <a href="javascript: void(0);" class="d-inline-block">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-3.jpg')); ?>" alt="" class="rounded-circle avatar-sm">
                                </a>
                            </div>
                            <div class="avatar-group-item">
                                <a href="javascript: void(0);" class="d-inline-block">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex">
                        <div class="avatar">
                            <span class="avatar-title rounded bg-light text-danger font-size-16">
                                <img src="<?php echo e(URL::asset('assets/images/companies/img-6.png')); ?>" alt="" height="30">
                            </span>
                        </div>
                        <div class="ms-auto">
                            <div class="dropdown float-end">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/riskimaulanarahman/Documents/www/borexstartup/resources/views/projects-grid.blade.php ENDPATH**/ ?>