...
unset($__errorArgs, $__bag); ?>" id="input-username" placeholder="Enter User Name" name="username">
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="mt-4 text-center">
                                                            <p class="mb-0"><b>© <script>document.write(new Date().getFullYear())</script> OAsys </b>. Crafted with <i class="mdi mdi-heart text-danger"></i><br>by <b>Planning KF</b></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\mysql\htdocs\oasys_update\resources\views/auth/login.blade.php ENDPATH**/ ?>