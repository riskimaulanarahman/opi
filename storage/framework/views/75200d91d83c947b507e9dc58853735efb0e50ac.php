...
<script type="text/javascript" src="<?php echo e(asset('assets/js/dx-quill.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/js/dx.all.js')); ?>"></script>

<?php echo $__env->yieldContent('script'); ?>
<?php echo $__env->yieldContent('script-bottom'); ?>
<?php /**PATH D:\xampp\htdocs\odpcustomer\resources\views/layouts/vendor-scripts.blade.php ENDPATH**/ ?>