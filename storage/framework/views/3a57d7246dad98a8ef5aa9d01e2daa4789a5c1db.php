...
<?php $__env->startSection('pagetitle'); ?>Material Design <?php $__env->stopSection(); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Material Design Icon</h4>
                </div><!-- end card header -->
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">All Icons</h4>
                </div><!-- end card header -->
                <div class="card-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/riskimaulanarahman/Documents/www/borexstartup/resources/views/icons-materialdesign.blade.php ENDPATH**/ ?>