    ...
    <div class="navbar-brand-box">
        <a href="<?php echo e(url('/')); ?>" class="logo logo-dark">
            <span class="logo-sm">
                ...
                <b style="font-size: 22px;">O</b>
            </span>
            <span class="logo-lg">
                
                <b style="font-size: 30px;">OCI</b>
            </span>
        </a>
        ...
        <a href="<?php echo e(url('/')); ?>" class="logo logo-light">
            <span class="logo-lg">
                ...
                <b style="font-size: 30px; color:white !important;">OCI</b>
            </span>
            <span class="logo-sm">
                
                <b style="font-size: 22px; color:white !important;">O</b>
            </span>
        </a>
    </div>
    ...
    <div data-simplebar class="sidebar-menu-scroll">
        ...
        <div class="p-3 px-4 sidebar-footer">
            <p class="mb-1 main-title">
                ...
                </script> &copy; <?php echo e(env('APP_NAME')); ?>

            </p>
            <p class="mb-0">Design & Develop by <?php echo e(env('APP_AUTHOR')); ?></p>
        </div>
    </div>
</div>
<!-- Left Sidebar End --><?php /**PATH /Users/riskimaulanarahman/Documents/www/odpcustomer/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>