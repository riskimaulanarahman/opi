<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.Projects_List'); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>


<?php $__env->startSection('pagetitle'); ?>Projects List <?php $__env->stopSection(); ?>
            ...
            <div class="">
                <div class="table-responsive">
                    <table class="table project-list-table table-nowrap align-middle table-borderless">
                        ...
                        <tbody>
                            <tr>
                                <td class="ps-4"><img src="<?php echo e(URL::asset('assets/images/companies/img-1.png')); ?>" alt=""
                                        class="avatar-sm"></td>
                                <td>
                            ...
                            <tr>
                                <td class="ps-4"><img src="<?php echo e(URL::asset('assets/images/companies/img-2.png')); ?>" alt=""
                                        class="avatar-sm"></td>
                                <td>
                                    <h5 class="text-truncate font-size-14"><a href="javascript: void(0);"
                            ...
                            <tr>
                                <td class="ps-4"><img src="<?php echo e(URL::asset('assets/images/companies/img-3.png')); ?>" alt=""
                                        class="avatar-sm"></td>
                                <td>
                                    <h5 class="text-truncate font-size-14"><a href="javascript: void(0);"
                            ...
                            <tr>
                                <td class="ps-4"><img src="<?php echo e(URL::asset('assets/images/companies/img-4.png')); ?>" alt=""
                                        class="avatar-sm"></td>
                                <td>
                                    <h5 class="text-truncate font-size-14"><a href="javascript: void(0);"
                            ...
                            <tr>
                                <td class="ps-4"><img src="<?php echo e(URL::asset('assets/images/companies/img-5.png')); ?>" alt=""
                                        class="avatar-sm"></td>
                                <td>
                                    <h5 class="text-truncate font-size-14"><a href="javascript: void(0);"
                                            class="text-dark">Borex Dashboard UI</a></h5>
                            ...
                            <tr>
                                <td class="ps-4"><img src="<?php echo e(URL::asset('assets/images/companies/img-6.png')); ?>" alt=""
                                        class="avatar-sm"></td>
                                <td>
                                    <h5 class="text-truncate font-size-14"><a href="javascript: void(0);"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/riskimaulanarahman/Documents/www/borexstartup/resources/views/projects-list.blade.php ENDPATH**/ ?>