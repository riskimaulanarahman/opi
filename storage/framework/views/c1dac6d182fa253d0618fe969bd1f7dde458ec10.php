...
<input type="hidden" name="usersid" id="usersid" value="<?php echo e(Auth::user()->id); ?>">
<input type="hidden" name="isadmin" id="isadmin" value="<?php echo e(Auth::user()->isAdmin); ?>">
<script>
    ...
    function sendRequestalt(url, method, data) {
        ...
        $.ajax(url+'?_token=' + '<?php echo e(csrf_token()); ?>', 
        {
            method: method || "GET",
            data: data,
...
</script><?php /**PATH /Users/riskimaulanarahman/Documents/www/odpcustomer/resources/views/layouts/service.blade.php ENDPATH**/ ?>