                ...
                <div class="flex-shrink-0 me-3">
                    <div class="avatar">
                        <div class="avatar-title rounded bg-primary bg-gradient">
                            <i class="fill-white <?php echo e($data['icon']); ?>"></i>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\mysql\htdocs\oasys_update\resources\views/master-grid/index.blade.php ENDPATH**/ ?>