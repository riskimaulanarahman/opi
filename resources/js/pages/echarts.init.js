...
// line chart
var barchartColors = getChartColorsArray("line-chart");
...
// mix line & bar
var barchartColors = getChartColorsArray("mix-line-bar");
...
// Doughnut Chart
var barchartColors = getChartColorsArray("doughnut-chart");
...
// pie chart
var barchartColors = getChartColorsArray("pie-chart");
...
// scatter chart
var barchartColors = getChartColorsArray("scatter-chart");
...
// candlestick chart
var barchartColors = getChartColorsArray("candlestick-chart");
    ...
    series: [{
        ...
        itemStyle: {
            normal: {
                ...
                color0: barchartColors[1],
                borderColor: barchartColors[0],
                borderColor0: barchartColors[1]
            }
        }
    }]
};
...
// gauge chart
var barchartColors = getChartColorsArray("gauge-chart");
    ...
    series: [
        {
            ...
            axisLine: {     
                lineStyle: {       
                    color: [[0.2, barchartColors[0]],[0.8, barchartColors[1]],[1, barchartColors[2]]], 
                    width: 20
                }
            },
