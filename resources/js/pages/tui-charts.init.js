...
// column charts
var barchartColors = getChartColorsArray("column-charts");
var columnChartWidth = document.getElementById("column-charts").offsetWidth;
...
// Line charts
var barchartColors = getChartColorsArray("line-charts");
...
// Area charts
var barchartColors = getChartColorsArray("area-charts");
...
// Radial charts
var barchartColors = getChartColorsArray("radial-charts");
...
// Bubble chart
var barchartColors = getChartColorsArray("bubble-charts");
var bubbleChartWidth = document.getElementById("bubble-charts").offsetWidth;
...
// Scatter chart
var barchartColors = getChartColorsArray("scatter-charts");
var scatterChartWidth = document.getElementById("scatter-charts").offsetWidth;
...
// Pie charts
var barchartColors = getChartColorsArray("pie-charts");
var pieChartWidth = document.getElementById("pie-charts").offsetWidth;
...
var donutpieChartWidth = document.getElementById("donut-charts").offsetWidth;
...
// Heatmap chart
var barchartColors = getChartColorsArray("heatmap-charts");
var heatmapchartsWidth = document.getElementById("heatmap-charts").offsetWidth;
...
var theme = {
    ...
    series: {
        startColor: barchartColors[0],
        endColor: barchartColors[1],
        overColor: barchartColors[2],
        borderColor: '#F4511E'
    }
};
...
// Treemap chart
var barchartColors = getChartColorsArray("treemap-charts");
var treemapchartsWidth = document.getElementById("treemap-charts").offsetWidth;
...
// Map charts
var barchartColors = getChartColorsArray("map-charts");
var mapchartsWidth = document.getElementById("map-charts").offsetWidth;
...
// Boxplot charts
var barchartColors = getChartColorsArray("boxplot-charts");
var boxplotchartsWidth = document.getElementById("boxplot-charts").offsetWidth;
...
// Bullet charts
var barchartColors = getChartColorsArray("bullet-charts");
