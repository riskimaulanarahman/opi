                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <a href="index" class="d-block auth-logo">
                                <img src="{{ URL::asset('assets/images/logo-dark.png') }}" alt="" height="22" class="auth-logo-dark mx-auto">
                                <img src="{{ URL::asset('assets/images/logo-light.png') }}" alt="" height="22" class="auth-logo-light mx-auto">
                            </a>
                            <div class="row justify-content-center mt-5">
                                <div class="col-sm-6">
                                    <div class="maintenance-img">
                                        <img src="{{ URL::asset('assets/images/coming-soon.png') }}" alt="" class="img-fluid mx-auto d-block">
                                    </div>
                                </div>
                            </div>
