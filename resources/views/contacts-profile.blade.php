                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table align-middle table-nowrap mb-0">
                                <tbody>
                                    <tr>
                                        <td style="width: 50px;"><img src="{{ URL::asset('assets/images/users/avatar-2.jpg') }}"
                                    ...
                                    <tr>
                                        <td><img src="{{ URL::asset('assets/images/users/avatar-1.jpg') }}" class="rounded-circle avatar-sm"
                                                alt=""></td>
                                        <td>
                                            <h5 class="font-size-14 m-0"><a href="javascript: void(0);"
                                    ...
                                    <tr>
                                        <td><img src="{{ URL::asset('assets/images/users/avatar-4.jpg') }}" class="rounded-circle avatar-sm"
                                                alt=""></td>
                                        <td>
                                            <h5 class="font-size-14 m-0"><a href="javascript: void(0);"
                            ...
                            <div class="px-3" data-simplebar style="max-height: 430px;">
                                <div class="d-flex align-items-start border-bottom pb-4">
                                    <div class="flex-shrink-0 me-2">
                                        <img class="rounded-circle avatar-sm" src="{{ URL::asset('assets/images/users/avatar-3.jpg') }}"
                                            alt="avatar-3 images">
                                    </div>
                                        ...
                                        <div class="d-flex align-items-start mt-4">
                                            <div class="flex-shrink-0 me-2">
                                                <img class="rounded-circle avatar-sm"
                                                    src="{{ URL::asset('assets/images/users/avatar-4.jpg') }}" alt="avatar-4 images">
                                            </div>
                                ...
                                <div class="d-flex align-items-start border-bottom py-4">
                                    <div class="flex-shrink-0 me-2">
                                        <img class="rounded-circle avatar-sm" src="{{ URL::asset('assets/images/users/avatar-5.jpg') }}"
                                            alt="avatar-5 images">
                                    </div>
                                ...
                                <div class="d-flex align-items-start border-bottom py-4">
                                    <div class="flex-shrink-0 me-2">
                                        <img class="rounded-circle avatar-sm" src="{{ URL::asset('assets/images/users/avatar-7.jpg') }}"
                                            alt="avatar-7 images">
                                    </div>
                        ...
                        <div>
                            ...
                            <div class="blog-post">
                                ...
                                <div class="position-relative mt-3">
                                    <img src="{{ URL::asset('./assets/images/post-1.jpg') }}" alt="" class="img-thumbnail">
                                </div>
                                <div class="pt-3">
                            ...
                            <div class="blog-post mt-4">
                                ...
                                <div class="position-relative mt-3">
                                    <img src="{{ URL::asset('./assets/images/post-2.jpg') }}" alt="" class="img-thumbnail">
                                </div>
                                <div class="pt-3">
                                    <div class="d-flex align-items-center justify-content-between border-bottom pb-3">
                                        <div>
