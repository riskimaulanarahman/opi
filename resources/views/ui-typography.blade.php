...
@section('pagetitle')Typography @endsection
    ...
    <div class="row">
        <div class="col-xl-6">
                ...
                <div class="card-body">
                    <div class="d-flex">
                        ...
                        <div class="flex-grow-1 align-self-center">
                            ...
                            <h5 class="mb-0">"Work Sans", sans-serif</h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-title-desc">All HTML headings, <code>&lt;h1&gt;</code> through <code>&lt;h6&gt;</code>,
                        are available.</p>

                    <h1 class="mb-3">h1. Bootstrap heading <small class="text-muted">2.03125rem
                            (32.5px)</small></h1>

                    <h2 class="mb-3">h2. Bootstrap heading <small class="text-muted">1.625rem (26px)</small>
                    </h2>

                    <h3 class="mb-3">h3. Bootstrap heading <small class="text-muted">1.42188rem
                            (22.75px)</small></h3>

                    <h4 class="mb-3">h4. Bootstrap heading <small class="text-muted">1.21875rem
                            (19.5px)</small></h4>

                    <h5 class="mb-3">h5. Bootstrap heading <small class="text-muted">1.01563rem
                            (16.25)</small></h5>
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-title-desc">Traditional heading elements are designed to work best in the meat of your
                        page content. </p>
    ...
    <div class="row">
        ...
        <div class="col-xl-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-title-desc">Remove the default <code class="highlighter-rouge">list-style</code> and left
                        margin on list
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <dl class="row mb-0">
                        ...
                        <dd class="col-sm-9">Vestibulum id ligula porta felis euismod semper eget lacinia odio sem
                            nec elit.</dd>
