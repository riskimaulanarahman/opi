                                                    ...
                                                    <div class="d-flex flex-column h-100">
                                                        <div class="mb-4 mb-md-5 text-center">
                                                            <a href="{{ URL::asset('index') }}" class="d-block auth-logo">
                                                                <img src="{{ URL::asset('assets/images/logo-sm.svg') }}" alt="" height="28"> <span class="logo-txt">Borex</span>
                                                            </a>
                                                        </div>
                                                        <div class="auth-content my-auto">
                                                            <div class="text-center">
                                                                <h5 class="mb-0">Confirm Password</h5>
                                                                <p class="text-muted mt-2">Re-Password with Borex.</p>
                                                            </div>
                                                            ...
                                                            <div class="mt-5 text-center">
                                                                <p class="text-muted mb-0">Remember It ?  <a href="{{ URL::asset('login') }}"
