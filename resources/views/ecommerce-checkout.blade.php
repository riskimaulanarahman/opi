...
@section('pagetitle')Checkout @endsection
                                                ...
                                                <div data-bs-toggle="collapse">
                                                    <label class="card-radio-label mb-0">
                                                        ...
                                                        <span class="card-radio text-truncate p-3">
                                                            ...
                                                            <span class="text-muted fw-normal text-wrap mb-1 d-block">109
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-centered mb-0 table-nowrap">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row"><img src="{{ URL::asset('assets/images/product/img-3.jpg') }}" alt="product-img"
                                            title="product-img" class="avatar-lg rounded"></th>
                                    <td>
                                        <h5 class="font-size-16 text-truncate"><a href="ecommerce-product-detail"
                                ...
                                <tr>
                                    <th scope="row"><img src="{{ URL::asset('assets/images/product/img-5.jpg') }}" alt="product-img"
                                            title="product-img" class="avatar-lg rounded"></th>
                                    <td>
                                        <h5 class="font-size-16 text-truncate"><a href="ecommerce-product-detail"
