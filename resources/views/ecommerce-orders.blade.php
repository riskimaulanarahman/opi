...
@section('pagetitle')Orders @endsection
                        ...
                        <table class="table align-middle table-nowrap">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">
                                        <div>
                                            <img src="{{ URL::asset('assets/images/product/img-1.jpg') }}" alt="" class="rounded avatar-md">
                                        </div>
                                    </th>
                                    <td>
                                        <div>
                                ...
                                <tr>
                                    <th scope="row">
                                        <div>
                                            <img src="{{ URL::asset('assets/images/product/img-2.jpg') }}" alt="" class="rounded avatar-md">
                                        </div>
                                    </th>
                                    <td>
                                        <div>
