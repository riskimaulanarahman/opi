...
@section('pagetitle')Add Product @endsection
    ...
    <div class="row mb-4">
        <div class="col text-end">
            <a href="#" class="btn btn-danger"> <i class="mdi mdi-close me-1"></i> Cancel </a>
            <a href="#" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#success-btn"> <i
                    class="mdi mdi-file-document-outline me-1"></i> Save </a>
        </div> <!-- end col -->
    </div> <!-- end row-->
    <!-- successfully modal  -->
