...
@section('pagetitle')Product Detail @endsection
                    ...
                    <div class="row">
                            ...
                            <div class="product-detail mt-3" dir="ltr">
                                ...
                                <div
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide"><img src="{{ URL::asset('assets/images/product/img-1.jpg') }}" alt=""
                                                class="img-fluid d-block" /></div>
                                        <div class="swiper-slide"><img src="{{ URL::asset('assets/images/product/img-2.jpg') }}" alt=""
                                                class="img-fluid d-block" /></div>
                                        <div class="swiper-slide"><img src="{{ URL::asset('assets/images/product/img-3.jpg') }}" alt=""
                                                class="img-fluid d-block" /></div>
                                        <div class="swiper-slide"><img src="{{ URL::asset('assets/images/product/img-6.jpg') }}" alt=""
                                                class="img-fluid d-block" /></div>
                                        <div class="swiper-slide"><img src="{{ URL::asset('assets/images/product/img-5.jpg') }}" alt=""
                                                class="img-fluid d-block" /></div>
                                    </div>
                                    ...
                                    <div class="swiper product-nav-slider mt-2 overflow-hidden">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide rounded">
                                                <div class="nav-slide-item"><img src="{{ URL::asset('assets/images/product/img-1.jpg') }}"
                                                        alt="" class="img-fluid d-block rounded" /></div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="nav-slide-item"><img src="{{ URL::asset('assets/images/product/img-2.jpg') }}"
                                                        alt="" class="img-fluid d-block rounded" /></div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="nav-slide-item"><img src="{{ URL::asset('assets/images/product/img-3.jpg') }}"
                                                        alt="" class="img-fluid d-block rounded" /></div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="nav-slide-item"><img src="{{ URL::asset('assets/images/product/img-6.jpg') }}"
                                                        alt="" class="img-fluid d-block rounded" /></div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="nav-slide-item"><img src="{{ URL::asset('assets/images/product/img-5.jpg') }}"
                                                        alt="" class="img-fluid d-block rounded" /></div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xl-8">
                            <div class="mt-3 mt-xl-3 ps-xl-5">
                                <h4 class="font-size-20 mb-3">Waterproof Mobile Phone +128GB</h4>
                                ...
                                <h3 class="mb-0 mt-4"><span class="text-muted me-2"><del
                                            class="font-size-22 fw-normal">$500</del></span><b>$450</b></h3>
                                    ...
                                    <div class="tab-pane fade" id="desc" role="tabpanel">
                                        <div class="row">
                                            <div class="col-sm-3 col-md-3">
                                                <div>
                                                    <img src="{{ URL::asset('assets/images/product/img-3.jpg') }}" alt=""
                                            ...
                                            <div class="col-sm-9 col-md-9">
                                                <div class="text-muted p-2">
                                                    <p>If several languages coalesce, the grammar of the resulting language
                                                        is more simple.</p>
                                                    <p>Everyone realizes a new common language would be desirable, one could
