...
@endsection
@section('content')
@section('pagetitle') Notifications @endsection
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-title-desc">Toasts are lightweight notifications designed to mimic the push notifications
                    </p>
                            ...
                            <div class="p-2">
                                ...
                                <div class="toast fade show" role="alert" aria-live="assertive" data-bs-autohide="false"
                                    ...
                                    <div class="toast-header">
                                        <img src="{{ URL::asset('assets/images/logo-dark-sm.png') }}" alt="" class="me-2" height="18">
                                        <strong class="me-auto">Borex</strong>
                            ...
                            <div class="p-2">
                                ...
                                <div class="bg-soft-light p-3">
                                    <div class="toast fade show" role="alert" aria-live="assertive" data-bs-autohide="false"
                                        aria-atomic="true">
                                        <div class="toast-header">
                                            <img src="{{ URL::asset('assets/images/logo-dark-sm.png') }}" alt="" class="me-2"
                                                height="18">
                                            <strong class="me-auto">Borex</strong>
                                            <small class="text-muted">11 mins ago</small>
                                            <button type="button" class="btn-close" data-bs-dismiss="toast"
