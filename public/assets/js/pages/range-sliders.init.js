...
var select = document.getElementById('input-select'); // Append the option elements
...
var slider2Value = document.getElementById('slider2-span'); // When the button is clicked, the locked state is inverted.
...
function crossUpdate(value, slider) {
  ...
  var a = slider1 === slider ? 0 : 1; // Invert a
