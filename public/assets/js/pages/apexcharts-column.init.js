...
chart.render(); // Column with Datalabels
...
chart.render(); // Stacked Columns Charts

var barchartColors = getChartColorsArray("column_stacked");
var options = {
  series: [{
    name: 'PRODUCT A',
...
chart.render(); // 100% Stacked Column Chart

var barchartColors = getChartColorsArray("column_stacked_chart");
var options = {
  series: [{
    name: 'PRODUCT A',
...
chart.render(); // column with Markers

var barchartColors = getChartColorsArray("column_markers");
var options = {
  series: [{
    name: 'Actual',
    data: [{
...
chart.render(); //  Column with Rotated Labels

var barchartColors = getChartColorsArray("column_rotated_labels");
var options = {
  series: [{
    name: 'Servings',
...
var barchartColors = getChartColorsArray("column_nagetive_values");
var options = {
  series: [{
    name: 'Cash Flow',
...
chart.render(); // Range Column Chart

var barchartColors = getChartColorsArray("column_range");
var options = {
  series: [{
    data: [{
      x: 'Team A',
...
chart.render(); // Dynamic Loaded Chart
...
var barchartColors = getChartColorsArray("column_distributed");
var options = {
  series: [{
