...
chart.render(); // Multiple Y-Axis Charts
...
chart.render(); // Line & Area Charts

var barchartColors = getChartColorsArray("line_area_chart");
var options = {
  series: [{
    name: 'TEAM A',
    type: 'area',
...
chart.render(); // Line Cloumn & Area Charts

var barchartColors = getChartColorsArray("line_area_charts");
var options = {
  series: [{
    name: 'TEAM A',
    type: 'column',
