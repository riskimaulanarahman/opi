...
chart.render(); //  Spline Area Charts
...
chart.render(); // Area Chart - Datetime X - Axis

var barchartColors = getChartColorsArray("area_chart_datetime");
var timelinechart = {
  series: [{
...
timelinechart.render(); // Datetime chart button
...
document.querySelector('#one_month').addEventListener('click', function (e) {
  resetCssClasses(e);
  timelinechart.zoomX(new Date('28 Jan 2013').getTime(), new Date('27 Feb 2013').getTime());
});
document.querySelector('#six_months').addEventListener('click', function (e) {
  resetCssClasses(e);
  timelinechart.zoomX(new Date('27 Sep 2012').getTime(), new Date('27 Feb 2013').getTime());
});
document.querySelector('#one_year').addEventListener('click', function (e) {
  resetCssClasses(e);
  timelinechart.zoomX(new Date('27 Feb 2012').getTime(), new Date('27 Feb 2013').getTime());
});
document.querySelector('#all').addEventListener('click', function (e) {
  resetCssClasses(e);
  timelinechart.zoomX(new Date('23 Jan 2012').getTime(), new Date('27 Feb 2013').getTime());
}); // Area with Nagetive Values

var barchartColors = getChartColorsArray("area_chart_negative");
var options = {
  series: [{
    name: 'North',
    data: [{
...
chart.render(); // Github Style - Area Charts

var barchartColors = getChartColorsArray("area_chart-months");
var options = {
  series: [{
    name: 'commits',
...
chart.render();
var barchartColors = getChartColorsArray("area_chart-years");
var optionsYears = {
  series: [{
    name: 'commits',
    data: githubdata.series
...
chartYears.render(); // Stacked Area Charts
...
var barchartColors = getChartColorsArray("area_chart_stacked");
var options = {
  series: [{
    name: 'South',
...
chart.render(); // Ireegular Time Series
...
var barchartColors = getChartColorsArray("area_chart_irregular");
var options = {
  series: [{
    name: 'PRODUCT A',
    data: dataSet[0]
...
chart.render(); // Area Chart With Null Values Chart

var barchartColors = getChartColorsArray("area-missing-null-value");
var options = {
  series: [{
    name: 'Network',
    data: [{
...
/******/ 		var installedChunks = {
/******/ 			"/assets/js/pages/apexcharts-area.init": 0,
/******/ 			"assets/css/app": 0,
/******/ 			"assets/css/icons": 0,
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkborex"] = self["webpackChunkborex"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["assets/css/app","assets/css/icons","assets/css/bootstrap"], function() { return __webpack_require__("./resources/js/pages/apexcharts-area.init.js"); })
