...
chart.render(); // Updating Donut Charts

var barchartColors = getChartColorsArray("updating_donut_chart");
var options = {
  series: [44, 55, 13, 33],
  chart: {
    height: 280,
...
var barchartColors = getChartColorsArray("gradient_chart");
var options = (_options = {
  ...
  position: 'bottom'
}), _defineProperty(_options, "colors", barchartColors), _options);
var chart = new ApexCharts(document.querySelector("#gradient_chart"), options);
chart.render(); // Pattern Donut chart

var barchartColors = getChartColorsArray("pattern_chart");
var options = {
  series: [44, 55, 41, 17, 15],
  chart: {
    height: 300,
...
chart.render(); // Pie Chart with Image Fill
...
var options = {
  ...
  fill: {
    ...
    opacity: 0.85,
    image: {
      src: ['./assets/images/auth-bg.jpg', './assets/images/small/img-3.jpg', './assets/images/small/img-5.jpg', './assets/images/small/img-2.jpg'],
      width: 25,
      imagedHeight: 25
    }
  },
...
chart.render(); // monochrome_pie_chart

var barchartColors = getChartColorsArray("monochrome_pie_chart");
var options = {
