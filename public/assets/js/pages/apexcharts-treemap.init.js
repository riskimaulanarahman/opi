...
chart.render(); // Multi - Dimensional Treemap
...
chart.render(); // Distributed Treemap

var barchartColors = getChartColorsArray("distributed_treemap");
var options = {
  series: [{
    data: [{
      x: 'New Delhi',
...
chart.render(); // Color Range Treemaps

var barchartColors = getChartColorsArray("color_range_treemap");
var options = {
  series: [{
    data: [{
      x: 'INTC',
  ...
  dataLabels: {
    ...
    formatter: function formatter(text, op) {
