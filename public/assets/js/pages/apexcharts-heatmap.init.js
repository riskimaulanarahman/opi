...
var barchartColors = getChartColorsArray("basic_heatmap");
var options = {
  series: [{
    name: 'Metric1',
...
chart.render(); // Generate Data Script
...
var barchartColors = getChartColorsArray("multiple_heatmap");
var options = {
  series: data,
  chart: {
    height: 450,
...
chart.render(); //   Color Range

var barchartColors = getChartColorsArray("color_heatmap");
var options = {
  series: [{
    name: 'Jan',
...
chart.render(); // Heatmap - Range Without Shades

var barchartColors = getChartColorsArray("shades_heatmap");
var options = {
  series: [{
    name: 'Metric1',
    data: generateData(20, {
