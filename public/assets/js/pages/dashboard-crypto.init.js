...
sparklinechart3.render(); // Column with Negative Values
...
var options = {
  series: [{
    data: [{
      ...
      y: [6612.09, 6615.13, 6605.09, 6612]
    }, {
...
chart.render(); // Chart-1

var barchartColors = getChartColorsArray("chart-1");
var options1 = {
  series: [{
    data: [25, 66, 41, 89, 63, 25, 44, 12, 36, 9, 54]
  }],
...
chart1.render(); // Chart-2

var barchartColors = getChartColorsArray("chart-2");
var options1 = {
  series: [{
...
chart1.render(); // Chart-3

var barchartColors = getChartColorsArray("chart-3");
var options1 = {
  series: [{
...
chart1.render(); // Chart-4

var barchartColors = getChartColorsArray("chart-4");
var options1 = {
  series: [{
...
chart1.render(); // Chart-5

var barchartColors = getChartColorsArray("chart-5");
var options1 = {
  series: [{
...
chart1.render(); // Chart-6

var barchartColors = getChartColorsArray("chart-6");
var options1 = {
  series: [{
    data: [50, 15, 35, 62, 23, 56, 44, 12, 36, 9, 54]
  }],
...
chart1.render(); // Chart-7

var barchartColors = getChartColorsArray("chart-7");
var options1 = {
  series: [{
...
var chart1 = new ApexCharts(document.querySelector("#chart-7"), options1);
chart1.render(); // Chart-8

var barchartColors = getChartColorsArray("chart-8");
var options1 = {
  series: [{
    data: [50, 15, 35, 62, 23, 56, 44, 12, 36, 9, 54]
  }],
...
var chart1 = new ApexCharts(document.querySelector("#chart-8"), options1);
chart1.render(); // Chart-9

var barchartColors = getChartColorsArray("chart-9");
var options1 = {
  series: [{
    data: [25, 66, 41, 89, 63, 25, 44, 12, 36, 9, 54]
  }],
...
var chart1 = new ApexCharts(document.querySelector("#chart-9"), options1);
chart1.render(); // Chart-10

var barchartColors = getChartColorsArray("chart-10");
var options1 = {
  series: [{
...
var chart1 = new ApexCharts(document.querySelector("#chart-10"), options1);
chart1.render();
/******/ })()
;