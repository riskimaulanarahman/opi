...
chart.render(); // Circle Chart - Custom Angle

var barchartColors = getChartColorsArray("circle_radialbar");
var options = {
  series: [76, 67, 61, 55],
  chart: {
    height: 350,
...
chart.render(); // Gradient Radialbar

var barchartColors = getChartColorsArray("gradient_radialbar");
var options = {
  series: [75],
  chart: {
    height: 350,
  ...
  fill: {
    ...
    gradient: {
      ...
      type: 'horizontal',
      shadeIntensity: 0.5,
      gradientToColors: barchartColors[(0, 1)],
      inverseColors: true,
      opacityFrom: 1,
      opacityTo: 1,
      stops: [0, 100]
...
chart.render(); // Semi Circle

var barchartColors = getChartColorsArray("semi_radialbar");
var options = {
  series: [76],
  chart: {
    type: 'radialBar',
