...
chart.render(); // Stacked Bar Charts

var barchartColors = getChartColorsArray("stacked_bar");
var options = {
  series: [{
    name: 'Marine Sprite',
...
chart.render(); // Stacked Bars 100

var barchartColors = getChartColorsArray("stacked_bar_100");
var options = {
  series: [{
    name: 'Marine Sprite',
    data: [44, 55, 41, 37, 22, 43, 21]
...
chart.render(); // Bar with Negative Values

var barchartColors = getChartColorsArray("negative_bars");
var options = {
  series: [{
    name: 'Males',
...
chart.render(); //   Bar with Markers

var barchartColors = getChartColorsArray("bar_markers");
var options = {
  series: [{
    name: 'Actual',
    data: [{
  ...
  dataLabels: {
    formatter: function formatter(val, opt) {
      var goals = opt.w.config.series[opt.seriesIndex].data[opt.dataPointIndex].goals; // if (goals && goals.length) {
...
chart.render(); // Reversed Bar Chart

var barchartColors = getChartColorsArray("reversed_bars");
var options = {
  series: [{
...
chart.render(); // Patterned Charts

var barchartColors = getChartColorsArray("patterned_bars");
var options = {
  series: [{
    name: 'Marine Sprite',
    data: [44, 55, 41, 37, 22, 43, 21]
...
chart.render(); // Groupes Bar Charts

var barchartColors = getChartColorsArray("grouped_bar");
var options = {
  series: [{
