...
chart.render(); //  Dashed line chart
...
chart.render(); // Line with Annotations

var barchartColors = getChartColorsArray("line_chart_annotations");
var options = {
  series: [{
  ...
  annotations: {
    ...
    points: [{
      ...
      image: {
        path: '../../assets/images/logo-dark-sm.png',
        width: 40,
        height: 40
      }
    }]
...
chart.render(); // Syncing Charts

var barchartColors = getChartColorsArray("syncingchart-line");
var options = {
  series: [{
...
chart.render();
var barchartColors = getChartColorsArray("syncingchart-area");
var optionsArea = {
  series: [{
    data: generateDayWiseTimeSeries(new Date('11 Feb 2017').getTime(), 20, {
      min: 10,
...
chartArea.render(); // function generateDayWiseTimeSeries(baseval, count, yrange) {
//   var i = 0;
//   var series = [];
//   while (i < count) {
//     var x = baseval;
...
var barchartColors = getChartColorsArray("brushchart_line2");
var options = {
  series: [{
    data: data
  }],
...
chart.render();
var barchartColors = getChartColorsArray("brushchart_line");
var optionsLine = {
  series: [{
    data: data
  }],
...
chartLine.render(); // Stepline Charts

var barchartColors = getChartColorsArray("line_chart_stepline");
var options = {
  series: [{
...
chart.render(); //   Gradient Line

var barchartColors = getChartColorsArray("line_chart_gradient");
var options = {
  series: [{
    name: 'Likes',
  ...
  fill: {
    ...
    gradient: {
      shade: 'dark',
      gradientToColors: barchartColors[0],
      shadeIntensity: 1,
      type: 'horizontal',
      opacityFrom: 1,
      opacityTo: 1,
...
chart.render(); //   Missing Data

var barchartColors = getChartColorsArray("line_chart_missing_data");
var options = {
  series: [{
    name: 'Peter',
...
var barchartColors = getChartColorsArray("line_chart_realtime");
var options = {
  series: [{
    data: data.slice()
  }],
