...
chart.render(); // Dtaetime - Scatter Charts
...
var barchartColors = getChartColorsArray("datetime_scatter");
var options = {
  series: [{
    name: 'TEAM 1',
...
chart.render(); // Scatter - Images Charts

var barchartColors = getChartColorsArray("images_scatter");
var options = {
  series: [{
    name: 'User A',
    data: [[16.4, 5.4], [21.7, 4], [25.4, 3], [19, 2], [10.9, 1], [13.6, 3.2], [10.9, 7], [10.9, 8.2], [16.4, 4], [13.6, 4.3], [13.6, 12], [29.9, 3], [10.9, 5.2], [16.4, 6.5], [10.9, 8], [24.5, 7.1], [10.9, 7], [8.1, 4.7]]
  }, {
    name: 'User B',
